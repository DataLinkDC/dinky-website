...
请查阅 [文档贡献](/docs/developer_guide/contribution/document)
 
## 参与代码贡献

IDEA 调试请查阅 [本地调试](/docs/developer_guide/local_debug) 及 [远程调试](/docs/developer_guide/remote_debug)

贡献请查阅 [Issue 需知](/docs/developer_guide/contribution/issue)，[Pull Request 需知](/docs/developer_guide/contribution/pull_request)，[Commit Message 需知](/docs/developer_guide/contribution/commit_message)
...
- 你应该新建一个分支来开始你的工作，分支的名字参考 [Pull Request 需知](/docs/developer_guide/contribution/pull_request)。比如，你想完成 feature 功能并提交了 Issue demo，那么你的 branch 名字应为 feature-demo。 功能名称可与导师讨论后确定。
- 完成后，发送一个 Pull Request 到 Dinky 的 dev 分支，提交过程具体请参考下面《[提交代码须知](/docs/developer_guide/contribution/commit_code)》。
